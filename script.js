/* ==========================================================================\
   ...
   ========================================================================== */
const CONFIG = {
    nomesCasal: "Jarielma & Railson",              // Nome dos dois
    dataInicio: "2025-09-28 20:30:00",           // Formato exato: AAAA-MM-DD HH:MM:SS
    ...
    sliderFotoFim: 10,                             // Número da última foto do Slider Principal (foto6.jpg)

    carrosselFotoInicio: 11,                       // Número da primeira foto da Galeria Horizontal (foto7.jpg)
    carrosselFotoFim: 20,                         // Número da última foto da Galeria Horizontal (foto12.jpg)
    
    // ===== CONFIGURAÇÃO DE MÚSICA DO YOUTUBE =====
    nomeMusica: "Jorge e Mateus - Pra Sempre Com Você", // Nome que aparecerá no player
    youtubeId: "xkX-fhGf3Qc",                     // ID do vídeo do YouTube
    // ==============================================

    // Texto romântico principal da página
    textoApaixonante: "Meu amor, eu prometo estar ao seu lado em cada capítulo da nossa história, nos dias de sol e também nas noites difíceis, quando tudo parecer silencioso demais. Prometo cuidar do seu coração com toda a delicadeza que existe em mim, porque desde que você chegou, eu entendi que amar alguém é encontrar um lar dentro de outro coração. Prometo nunca deixar a rotina apagar o brilho dos nossos momentos, continuar admirando o seu sorriso como na primeira vez, segurar sua mão com orgulho e te lembrar todos os dias do quanto você é especial para mim. Quero ser o abraço que te acalma, o olhar que te dá segurança e a pessoa que estará ao seu lado quando o mundo parecer pesado demais. Eu prometo celebrar cada conquista sua como se fosse minha, enxugar suas lágrimas quando for preciso e nunca desistir de nós por causa de fases difíceis. Porque amar você não é apenas sentir borboletas no estômago… é ter a certeza de que encontrei a pessoa com quem quero dividir minha vida inteira. E se um dia a vida nos testar, eu prometo continuar escolhendo você. Escolher ouvir você, entender você, cuidar de você e lutar pelo nosso amor. Porque entre bilhões de pessoas no mundo, foi no seu coração que eu encontrei paz, felicidade e sentido. Você é a minha melhor coincidência, o meu lugar favorito, o sonho que a vida resolveu tornar real. E enquanto existir tempo, enquanto meu coração bater, eu vou te amar com a mesma intensidade do primeiro olhar… ou talvez até mais."
};
